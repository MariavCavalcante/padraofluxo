...
const CONFIG = {
  ...
  // --------------------------------------------------------------------
  // NOMES DAS COLUNAS NA ABA DISTÂNCIA
  // --------------------------------------------------------------------
  // Centralizado aqui porque o nome da coluna de distância já mudou uma
  // vez na planilha real (de "Distancia" para "Distância Atualizada (km)",
  // quando foi adicionada a coluna de Tempo Estimado, em 21/08/2026). Se
  // mudar de novo, ajuste apenas aqui.
  COLUNAS_DISTANCIA: {
    MUNICIPIO_SOLICITANTE: 'Município Solicitante',
    MUNICIPIO_EXECUTANTE: 'Município Executante',
    DISTANCIA: 'Distância Atualizada (km)',
    // Disponível na planilha desde 21/08/2026, mas ainda não usada na
    // interface do painel:
    TEMPO_ESTIMADO_MIN: 'Tempo Estimado (min)'
  },
